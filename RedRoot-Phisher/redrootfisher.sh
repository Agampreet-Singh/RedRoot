...
animated_welcome() {
    clear
    local message="Welcome Mr. Agampreet"
    local styled=""
    local colors=("$RED" "$GOLDEN")  # Alternating RED and reset (GOLDEN means default)

    for ((i=0; i<${#message}; i++)); do
        local color="${colors[i % 2]}"
        local char="${message:$i:1}"
        styled+="${color}${char}"
        printf "\r%s${GOLDEN}" "$styled"
        sleep 0.05
    done
...
banner() {
    animated_welcome
    echo -e "${RED}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓"
    echo -e "${RED}┃${YELLOW}               REDROOT PHISHING TOOL                ${RED}┃"
    echo -e "${RED}┃${CYAN}               Created by Agampreet                 ${RED}┃"
    echo -e "${RED}┃${MAGENTA}               Version: Latest                      ${RED}┃"
    echo -e "${RED}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${WHITE}"
...
banner_small() {
    echo -e "${RED}╭────────────────────────────────────────────╮"
    echo -e "${RED}│${CYAN}           REDROOT TOOL - QUICK LAUNCH         ${RED}│"
    echo -e "${RED}╰────────────────────────────────────────────╯${WHITE} ${__version__}"
}
...
main_menu() {
	...
	cat <<- EOF
-----------------------------------------------------------------------------------------------------------
|	${RED}[${CYAN}::${RED}]${GOLDEN} Select the Options for the Ph.  ${RED}[${CYAN}::${RED}]${GOLDEN} |
-----------------------------------------------------------------------------------------------------------

------------------------------------------------------------------------------------------------------------------------------------------------------
|               ${RED}[${CYAN}01${RED}]${GREEN} Facebook      ${RED}[${CYAN}11${RED}]${ORANGE} Twitch       ${RED}[${CYAN}21${RED}]${MAGENTA} DeviantArt             
|       	${RED}[${CYAN}02${RED}]${GREEN} Instagram     ${RED}[${CYAN}12${RED}]${ORANGE} Pinterest    ${RED}[${CYAN}22${RED}]${MAGENTA} Badoo                  
|      		${RED}[${CYAN}03${RED}]${GREEN} Google        ${RED}[${CYAN}13${RED}]${ORANGE} Snapchat     ${RED}[${CYAN}23${RED}]${MAGENTA} Origin                 
|		${RED}[${CYAN}04${RED}]${GREEN} Microsoft     ${RED}[${CYAN}14${RED}]${ORANGE} Linkedin     ${RED}[${CYAN}24${RED}]${MAGENTA} DropBox	             
|		${RED}[${CYAN}05${RED}]${GREEN} Netflix       ${RED}[${CYAN}15${RED}]${ORANGE} Ebay         ${RED}[${CYAN}25${RED}]${MAGENTA} Yahoo		     
|		${RED}[${CYAN}06${RED}]${GREEN} Paypal        ${RED}[${CYAN}16${RED}]${ORANGE} Quora        ${RED}[${CYAN}26${RED}]${MAGENTA} Wordpress              
|		${RED}[${CYAN}07${RED}]${GREEN} Steam         ${RED}[${CYAN}17${RED}]${ORANGE} Protonmail   ${RED}[${CYAN}27${RED}]${MAGENTA} Yandex	             
|		${RED}[${CYAN}08${RED}]${GREEN} Twitter       ${RED}[${CYAN}18${RED}]${ORANGE} Spotify      ${RED}[${CYAN}28${RED}]${MAGENTA} StackoverFlow          
|		${RED}[${CYAN}09${RED}]${GREEN} Playstation   ${RED}[${CYAN}19${RED}]${ORANGE} Reddit       ${RED}[${CYAN}29${RED}]${MAGENTA} Vk                     
|		${RED}[${CYAN}10${RED}]${GREEN} Tiktok        ${RED}[${CYAN}20${RED}]${ORANGE} Adobe        ${RED}[${CYAN}30${RED}]${MAGENTA} XBOX                   
|		${RED}[${CYAN}31${RED}]${GREEN} Mediafire     ${RED}[${CYAN}32${RED}]${ORANGE} Gitlab       ${RED}[${CYAN}33${RED}]${MAGENTA} Github                 
|		${RED}[${CYAN}34${RED}]${GREEN} Discord       ${RED}[${CYAN}35${RED}]${ORANGE} Roblox                                                                
|------------------------------------------------------------------------------------------------------------------------------------------------------		     
|		${RED}[${WHITE}99${RED}]${ORANGE} About         ${RED}[${WHITE}00${RED}]${ORANGE} Exit                                                               
-------------------------------------------------------------------------------------------------------------------------------------------------------
	EOF
	
	read -p "${RED}[${WHITE}-${RED}]${GREEN} RedRoot - Phishing : ${BLUE}"
